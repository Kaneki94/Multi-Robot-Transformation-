...
public class RCC_CarControllerV3 : MonoBehaviour {
	...
	void Awake (){
		...
		if (GetComponent<EffectListener>() && !VFX)
			VFX = GetComponent<EffectListener>();
        ...
        if (GetComponentInChildren<WheelCollider>())
...
//
	...
	private void NOS(){
		...
		if (!NOSSound)
		{
			NOSSound = RCC_CreateAudioSource.NewAudioSource(gameObject, "NOS Sound AudioSource", 2000, 3000, 1f, NOSClip, true, false, false);
		}
