...
namespace SWS
{
    ...
    public class splineMove : MonoBehaviour
    {
        ...
        {
            if (nottraffic)
            pathContainer = GetComponent<objstopass>().manager.GetComponent<enemypaths>().pathz[pathnum];
        ...
        {
          //  Debug.Log("workinggggggggggggggggggggggg alotttttttttttttttt");
