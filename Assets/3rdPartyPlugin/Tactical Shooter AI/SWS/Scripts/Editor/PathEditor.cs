...
namespace SWS
{
    ...
    public class PathEditor : Editor
    {
      ...
      //  private SerializedProperty m_Check3;
        ...
        */
        ...
        public void OnEnable()
        {
           ...
           // m_Check3 = m_Object.FindProperty("pathfilled");
        ...
        public override void OnInspectorGUI()
        {
          ...
          //  m_Check3.boolValue = EditorGUILayout.Toggle("Path Filled", m_Check3.boolValue);
          // m_Check2.boolValue = EditorGUILayout.Toggle("Path Filled", m_Check2.boolValue);
