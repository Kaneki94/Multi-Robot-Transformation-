...
namespace CnControls
{
	...
	public class CnInputManager
	{
		...
		public static int TouchCount {
			get {
				return ControlFreak2.CF2Input.touchCount;
			}
		}
		...
		/// It's possible to add some reflection-based emulated touches
		/// </summary>
		public static ControlFreak2.InputRig.Touch GetTouch (int touchIndex)
		{
			return ControlFreak2.CF2Input.GetTouch (touchIndex);
		}
		...
		private static float GetAxis (string axisName, bool isRaw)
		{
			...
			return isRaw ? ControlFreak2.CF2Input.GetAxisRaw (axisName) : ControlFreak2.CF2Input.GetAxis (axisName);
//			return 0f;
		}
