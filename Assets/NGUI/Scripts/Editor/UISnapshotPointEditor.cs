...
public class UISnapshotPointEditor : Editor
{
	...
	GameObject GetPrefab ()
	{
        ...
        //mmmmm GameObject go = PrefabUtility.FindPrefabRoot(t == null ? point.gameObject : t.gameObject);
        //mmmmm if (go == null) return null;

        // Actual prefab
        //mmmmm return PrefabUtility.GetPrefabParent(go) as GameObject;
        return null;
	}
}
