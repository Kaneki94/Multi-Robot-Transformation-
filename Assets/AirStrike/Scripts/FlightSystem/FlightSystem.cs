...
public class FlightSystem : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
        ...
        //}
        //else if(groundchk == false) {
           // GetComponent<Rigidbody>().isKinematic = false;
            MoveSpeed = Mathf.Lerp(MoveSpeed, Speed, Time.deltaTime);
         
       // }
        if (this.transform.localPosition.y < height) {
            this.transform.localPosition = new Vector3(this.transform.localPosition.x, height, transform.localPosition.z);
        }
	}
