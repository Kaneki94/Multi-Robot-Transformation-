    ...
    private void Init()
    {
        ...
        MobileAds.Initialize((initStatus) =>
        {
            ...
            if (PlayerPrefs.GetInt("RemoveAds") != 1)
            {
                ...
                LoadMediumBanner();
                LoadInterstitial(); ///Edit for new strategy
            }
    ...
    public override void LoadSmallBanner()
    {
        ...
        if (Application.internetReachability == NetworkReachability.ReachableViaCarrierDataNetwork | Application.internetReachability == NetworkReachability.ReachableViaLocalAreaNetwork)
        {
            if (SmallBanner_High_Ecpm)
            {
                ...
                this.SmallBanner_High_ECPM = new BannerView(ADMOB_ID.ADMOB_BANNER_AD_ID_HIGH__ECPM, AdSize.Banner, AdPosition.TopRight);
                BindSmallBannerEvents();
            ...
            else if (SmallBanner_Medium_Ecpm)
            {
                ...
                this.SmallBanner_Medium_ECPM = new BannerView(ADMOB_ID.ADMOB_BANNER_AD_ID_MEDIUM__ECPM, AdSize.Banner, AdPosition.TopRight);
            ...
            else if (SmallBanner_LowEcpm)
            {
                ...
                //#endif
                this.SmallBanner_Low_ECPM = new BannerView(ADMOB_ID.ADMOB_BANNER_AD_ID_LOW__ECPM, AdSize.Banner, AdPosition.TopRight);
