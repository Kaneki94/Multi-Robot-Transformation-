...
public class enemywatch1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Vector3 boundlook = new Vector3(target[0].transform.position.x, target[0].transform.position.y, target[0].transform.position.z);
        ...
        else if (Vector3.Distance(transform.position, target[1].transform.position) < 60f && target[1].activeInHierarchy)
        {
            ...
            Vector3 boundlook = new Vector3(target[1].transform.position.x, target[1].transform.position.y, target[1].transform.position.z);
            this.gameObject.GetComponent<splineMove>().Pause();
            if (GetComponent<Animator>())
                this.gameObject.GetComponent<Animator>().Play("idle");
            transform.LookAt(boundlook);
        ...
        {
            Vector3 boundlook = new Vector3(target[2].transform.position.x, target[2].transform.position.y, target[2].transform.position.z);
            this.gameObject.GetComponent<splineMove>().Pause();
            if (GetComponent<Animator>())
                this.gameObject.GetComponent<Animator>().Play("idle");
            transform.LookAt(boundlook);
        ...
        {
            Vector3 boundlook = new Vector3(target[3].transform.position.x, target[3].transform.position.y, target[3].transform.position.z);
            this.gameObject.GetComponent<splineMove>().Pause();
            if (GetComponent<Animator>())
                this.gameObject.GetComponent<Animator>().Play("idle");
            transform.LookAt(boundlook);
        ...
        {
            Vector3 boundlook = new Vector3(target[4].transform.position.x, target[4].transform.position.y, target[4].transform.position.z);
            this.gameObject.GetComponent<splineMove>().Pause();
            if (GetComponent<Animator>())
                this.gameObject.GetComponent<Animator>().Play("idle");
            transform.LookAt(boundlook);
